...
- API keys, search keys, MCP secrets, and transport credentials are stored securely in your OS-level credential vault (e.g., macOS Keychain, Windows Credential Manager, or Linux Secret Service)
