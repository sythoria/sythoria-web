...
| --------------------------- | ---------------------------------------------------------- | -------------- |
| `claude-sonnet-4-20250514`  | Balanced performance — everyday tasks, coding, analysis    | 200K           |
| `claude-3-5-haiku-20241022` | Fast, lightweight responses — quick Q&A, simple tasks      | 200K           |
| `claude-opus-4-20250514`    | Most capable — complex reasoning, research, long documents | 200K           |
