...
Ollama models are entered manually in Settings under **Model ID** (e.g., `llama3.1`, `mistral`, or `deepseek-r1`). Ensure you have downloaded the model locally via the Ollama command line before attempting to use it in Sythoria.
