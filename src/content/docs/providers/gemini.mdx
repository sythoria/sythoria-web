...
| ------------------ | --------------------------------------------------------------- | -------------- |
| `gemini-2.5-pro`   | Most capable — complex reasoning, long documents, deep analysis | 1M             |
| `gemini-2.5-flash` | Fast and efficient — everyday tasks, quick Q&A                  | 1M             |
| `gemini-2.0-flash` | Previous generation flash — general-purpose, cost-effective     | 1M             |
